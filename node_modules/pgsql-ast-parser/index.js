...
class AstDefaultMapper {
    ...
    insert(val) {
        ...
        if (!(values === null || values === void 0 ? void 0 : values.length) && !select) {
            // nothing to insert
            return null;
        }
        const returning = arrayNilMap(val.returning, c => this.selectionColumn(c));
...
const grammar = {
    ...
    ParserRules: [
        ...
        { "name": "select_table_base", "symbols": ["table_ref_aliased"], "postprocess": x => {
                return lexer_2.track(x, { type: 'table', ...x[0] });
            } },
        ...
        { "name": "select_table_base$ebnf$1$subexpression$1$ebnf$1", "symbols": [(lexer_1.lexerAny.has("kw_as") ? { type: "kw_as" } : kw_as)], "postprocess": id },
        ...
        { "name": "select_table_base", "symbols": ["expr_call", "select_table_base$ebnf$1"], "postprocess": x => !x[1]
                ? x[0]
                : lexer_2.track(x, {
                    ...x[0],
                    alias: asName(x[1]),
        ...
        { "name": "select_subject_select_statement", "symbols": ["selection_paren", "ident_aliased"], "postprocess": x => lexer_2.track(x, {
                type: 'statement',
        ...
        { "name": "select_subject_select_values", "symbols": ["lparen", "kw_values", "insert_values", "rparen", (lexer_1.lexerAny.has("kw_as") ? { type: "kw_as" } : kw_as), "ident", "select_subject_select_values$ebnf$1"], "postprocess": x => lexer_2.track(x, {
                type: 'values',
                alias: asName(x[5]),
                values: x[2],
                ...x[6] && { columnNames: lexer_2.unbox(x[6]).map(asName) },
            }) },
        ...
        { "name": "createtable_statement", "symbols": [(lexer_1.lexerAny.has("kw_create") ? { type: "kw_create" } : kw_create), (lexer_1.lexerAny.has("kw_table") ? { type: "kw_table" } : kw_table), "createtable_statement$ebnf$1", "qname", "lparen", "createtable_declarationlist", "rparen", "createtable_statement$ebnf$2"], "postprocess": x => {
                const cols = x[5].filter((v) => 'kind' in v);
                const constraints = x[5].filter((v) => !('kind' in v));
                return lexer_2.track(x, {
                    type: 'create table',
        ...
        { "name": "insert_statement$ebnf$5$subexpression$1", "symbols": [(lexer_1.lexerAny.has("kw_on") ? { type: "kw_on" } : kw_on), "kw_conflict", "insert_on_conflict"], "postprocess": last },
        ...
        { "name": "insert_statement$ebnf$6$subexpression$1", "symbols": [(lexer_1.lexerAny.has("kw_returning") ? { type: "kw_returning" } : kw_returning), "select_expr_list_aliased"], "postprocess": last },
        ...
        { "name": "insert_single_value$subexpression$1", "symbols": [(lexer_1.lexerAny.has("kw_default") ? { type: "kw_default" } : kw_default)], "postprocess": () => 'default' },
        ...
        { "name": "delete_truncate", "symbols": ["delete_truncate$subexpression$1", "delete_truncate$macrocall$1"], "postprocess": x => lexer_2.track(x, {
                type: 'truncate table',
                tables: x[1],
            }) },
