...
import { IValue, _ITable, CreateIndexDef, _Transaction, _ISchema, _Column, SchemaField, _IIndex, _Explainer, _SelectExplanation, ChangeHandler, Stats, DropHandler, IndexHandler, Reg, ChangeOpts } from './interfaces-private';
import { Map as ImMap } from 'immutable';
import { CreateColumnDef, TableConstraintForeignKey, TableConstraint, Expr, ExprRef } from 'pgsql-ast-parser';
...
export declare class MemoryTable<T = any> extends DataSourceBase<T> implements IMemoryTable, _ITable<T> {
    ...
    addCheck(_t: _Transaction, check: Expr, constraintName?: string): void;
    ...
    addForeignKey(cst: TableConstraintForeignKey, t: _Transaction): this;
